...
{:else if data.counterparty}
	...
	<section class="mb-6" data-testid="counterparty-info">
		<h3 class="mb-2 text-sm font-semibold uppercase text-surface-600-400">Counterparty information</h3>
	...
	<section class="mb-6" data-testid="counterparty-routing">
		<h3 class="mb-2 text-sm font-semibold uppercase text-surface-600-400">Routing</h3>
		<dl class="grid grid-cols-1 gap-3 sm:grid-cols-2">
			<div>
	...
	{#if cp.metadata}
		<section class="mb-6" data-testid="counterparty-metadata">
			<h3 class="mb-2 text-sm font-semibold uppercase text-surface-600-400">Metadata</h3>
			<dl class="grid grid-cols-1 gap-3 sm:grid-cols-2">
				<div>
	...
	{#if cp.bespoke && cp.bespoke.length > 0}
		<section class="mb-6" data-testid="counterparty-bespoke">
			<h3 class="mb-2 text-sm font-semibold uppercase text-surface-600-400">Bespoke</h3>
